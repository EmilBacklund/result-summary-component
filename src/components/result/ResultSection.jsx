const ResultSection = (props) => {
  return (
    <section className='rounded-xxxxl text-lg text-white flex flex-col justify-between items-center pt-[38px] pb-[55px] px-[54px] text-center w-1/2 bg-gradient-to-b from-gradientTopColor to-gradientBotColor'>
      <div>
